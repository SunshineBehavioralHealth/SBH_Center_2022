...
class Component implements Component_Interface
{
	...
	public function action_enqueue_navigation_script()
	{
		...
		// wp_enqueue_script(
		// 	'sbh_center-navigation',
		// 	get_theme_file_uri( '/js/navigation.min.js' ),
		// 	[],
		// 	sbh_center()->get_asset_version( get_theme_file_path( '/js/navigation.min.js' ) ),
		// 	false
		// );
		wp_script_add_data('sbh_center-navigation', 'async', true);
		wp_script_add_data('sbh_center-navigation', 'precache', true);
		wp_localize_script(
			'sbh_center-navigation',
			'sbh_centerScreenReaderText',
			[
				'expand'   => __('Expand child menu', 'sbh_center'),
				'collapse' => __('Collapse child menu', 'sbh_center'),
			]
		);
	}
