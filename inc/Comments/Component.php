 ...
 * * `sbh_center()->the_comments( array $args = [] )`
 *
...
class Component implements Component_Interface, Templating_Component_Interface
{
	...
	public function the_comments(array $args = [])
	{
		...
		$amp_live_list = sbh_center()->using_amp_live_list_comments();
...
?>
			...
			?>
				<div update>
					<button class="button" on="tap:amp-live-comments-list-<?php the_ID(); ?>.update"><?php esc_html_e('New comment(s)', 'sbh_center'); ?></button>
				</div>
			</amp-live-list>
<?php
			}
