...
class Component implements Component_Interface
{
	...
	{
		$lazyload_choices = [
			'lazyload'    => __('Lazy-load on (default)', 'sbh_center'),
			'no-lazyload' => __('Lazy-load off', 'sbh_center'),
		];
		...
		$wp_customize->add_control(
			'lazy_load_media',
			[
				'label'           => __('Lazy-load images', 'sbh_center'),
				'section'         => 'theme_options',
				'type'            => 'radio',
				'description'     => __('Lazy-loading images means images are loaded only when they are in view. Improves performance, but can result in content jumping around on slower connections.', 'sbh_center'),
	...
	{
		wp_script_add_data('sbh_center-lazy-load-images', 'defer', true);
		wp_script_add_data('sbh_center-lazy-load-images', 'precache', true);
	}
