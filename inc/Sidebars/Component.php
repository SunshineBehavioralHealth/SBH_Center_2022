 ...
 * * `sbh_center()->is_primary_sidebar_active()`
 * * `sbh_center()->display_primary_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface
{
	...
	public function action_register_sidebars()
	{
		register_sidebar(
			[
				'name'          => esc_html__('Sidebar', 'sbh_center'),
				'id'            => static::PRIMARY_SIDEBAR_SLUG,
				'description'   => esc_html__('Add widgets here.', 'sbh_center'),
	 ...
	 * @return array Filtered body classes.mn
	 */
